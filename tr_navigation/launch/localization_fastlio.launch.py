...
def generate_launch_description():
    declare_pcd_map = DeclareLaunchArgument('pcd_map', 
                                            default_value= '/home/home/RCI_dual_steering_ws/src/tr_simulation/pcd/vlp16.pcd',
                                            description='Full path to map(pcd)file')
    declare_yaml_map = DeclareLaunchArgument('yaml_map', 
                                            default_value= '/home/home/RCI_dual_steering_ws/src/tr_simulation/maps/vlp16.yaml',
                                            description='Full path to map(yaml)file')
    declare_use_sim_time = DeclareLaunchArgument('use_sim_time', default_value='true')
    declare_params = DeclareLaunchArgument('params_file', 
                                           default_value= '/home/home/RCI_dual_steering_ws/src/tr_simulation/config/velodyne16_localization.yaml',
    ...
    tr_navigation_share = get_package_share_directory('tr_simulation')
    rviz_cfg = os.path.join(tr_navigation_share, 'rviz', 'localization.rviz')
    localization_config = os.path.join(tr_navigation_share, 'config', 'velodyne16_localization.yaml')
    ekf_config_path = os.path.join(tr_navigation_share, 'config', 'ekf.yaml')
